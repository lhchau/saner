...
python train.py configs/sam.yaml --optimizer.opt_name=saner --optimizer.group=B --optimizer.alpha=0.25 --trainer.alpha_scheduler=0 --model.model_name=wideresnet40_2 --model.widen_factor=1 --dataloader.data_name=cifar10 --dataloader.noise=0.25 --dataloader.noise_type=symmetric --trainer.seed=42 --logging.framework_name=wandb --logging.project_name=cifar10-label-noise-rebuttal
