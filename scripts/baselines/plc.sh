...
python baselines/train_plc.py configs/sgd_plc.yaml \
  ...
  --logging.project_name=cifar10-sam-noise-plc
...
python baselines/train_plc.py configs/sam_plc.yaml \
...
python baselines/train_plc.py configs/sgd_plc.yaml \
  ...
  --trainer.seed=43 \
  --logging.framework_name=wandb \
  --logging.project_name=cifar100-sam-noise-plc
