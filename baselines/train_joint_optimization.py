"""Joint Optimization framework (Tanaka et al., 2018), stage 1: trains with
a combined classification + label-regularization loss (jo_criterion, see
utils/jo_regularization.py) and writes out corrected soft labels to labels/
for stage 2 (retrain_joint_optimization.py) to consume."""
import os
import sys
