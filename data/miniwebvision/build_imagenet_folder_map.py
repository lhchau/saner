# Builds the WebVision-query-folder -> ImageNet-class-name lookup tables used by
# prepare_miniwebvision.sh to re-arrange the raw WebVision download into an
# ImageNet-style directory layout. Expects to be run from data/miniwebvision/
# after `info.tar` has been extracted (info/synsets.txt, info/queries_synsets_map.txt,
# info/val_filelist.txt must exist).
